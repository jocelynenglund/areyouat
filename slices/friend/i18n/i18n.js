...
(function () {
  const STRINGS = {
    ...
    en: {
      app_title: 'Are you on?',
      app_title_short: 'are you on?',
      loading: 'peekin…',
      ...
      landing_about2: 'no app. no account. wipes at midnight.',
      about_page_title: 'Are you on? — about',
      ...
      about_footer: 'No sign-up. No app. Wipes at midnight.',
      about_back: '← back',
