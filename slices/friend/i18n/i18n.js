...
(function () {
  const STRINGS = {
    sv: {
      ...
      share_card_building: 'bygger bild…',
      share_card_action: 'dela bild + länk',
      share_card_here: 'här nu',
      card_nobody_here: 'ingen här än',
      summary_here_at: '{n} här på {place}',
      summary_on_the_way: '{n} på väg',
      summary_in_spirit: '{n} i tanken',
      on_the_way: 'på väg',
...
arrived: 'jag är här',
      ...
      in_spirit: 'i tanken',
      cant_make_it: 'jag kan inte — men jag är med',
      spirit_prompt: 'med er i tanken?',
      spirit_hint: 'du kan inte komma, men du finns med ändå',
      spirit_note_placeholder: 'en hälsning (valfritt)',
      spirit_submit: 'jag är med',
      spirit_undo: 'ångra',
      eta_arriving_soon: 'är du framme? tryck för att checka in',
    ...
    en: {
      ...
      share_copy: 'copy',
      share_copied: 'copied',
      share_card_building: 'building image…',
      share_card_action: 'share image + link',
      share_card_here: 'here now',
      card_nobody_here: 'nobody here yet',
      summary_here_at: '{n} here at {place}',
      summary_on_the_way: '{n} on the way',
      summary_in_spirit: '{n} in spirit',
      ...
      in_spirit: 'in spirit',
      cant_make_it: 'can\'t make it — but I\'m with you',
      spirit_prompt: 'with them in spirit?',
      spirit_hint: 'you can\'t come, but you\'re here anyway',
      spirit_note_placeholder: 'a note (optional)',
      spirit_submit: 'I\'m with you',
      spirit_undo: 'undo',
      eta_arriving_soon: 'are you there yet? tap to check in',
